        ...
        <div class="category">
            ...
            <ul>
                ...
                <?php foreach ($categories as $category) : ?>
                    ...
                    $linkCategoryDetail = $router->generate('category', ['slug' => $slug, 'categoryId' => $category->getId()])
                    ?>
                    <li class="<?= $category_id == $category->getId() ? 'active' : '' ?>">
                        <a href="<?= $linkCategoryDetail ?>" title="<?= $category->getName() ?>" target="_self"><?= $category->getName() ?></a>
                    </li>
                <?php endforeach ?>
