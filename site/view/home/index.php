...
<main id="maincontent" class="page-main">
    <div class="container">
        ...
        <?php foreach ($categoriedProducts as $categoriedProduct) :
            $category_name = $categoriedProduct['category_name'];
            $products = $categoriedProduct['products'];
        ?>
            <div class="row equal">
                <div class="col-xs-12">
                    <h4 class="home-title"><?= $category_name ?></h4>
                </div>
